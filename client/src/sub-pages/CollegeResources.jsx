  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6 text-center pb-10">
        Empowering Students with Comprehensive College Resources
      </h1>
      <p className="font-bold mb-6 text-center pb-10">
        At the Quantum Innovation Institute of Technology, we understand that
        the journey through college is enriched by access to a wide range of
        resources designed to support both academic and personal growth. Our
        comprehensive suite of college resources includes dedicated academic
        advising, cutting-edge research facilities, extensive library
        collections, and specialized tutoring services. We also offer career
        counseling, wellness programs, and extracurricular opportunities to help
        students achieve their full potential. Whether you're seeking guidance
        on coursework, looking for ways to enhance your skills, or in need of
        support during challenging times, our resources are here to provide the
        assistance you need to thrive in your academic and personal endeavors.
      </p>

      <h1 className="text-2xl font-bold mb-6">College Resources</h1>
