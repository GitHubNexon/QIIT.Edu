...
const DEFAULTS = {
  title: "Bachelor's Program Overview",
  description: "Explore the exciting opportunities and requirements for pursuing a bachelor's degree in our esteemed program.",
  image: "/images/bachelors-card.jpg",
  link: "/programs/bachelors-card",
};
